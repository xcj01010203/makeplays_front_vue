...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\front\\makeplays\\apps\\home\\tpl\\index.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-72d3bb5c&file=index.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-72d3bb5c&file=index.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\front\\makeplays\\apps\\home\\tpl\\content.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-36fdb1fa&file=content.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./content.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-36fdb1fa&file=content.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./content.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	// 						<p>已完成拍摄 86 /3,090 场</p>

	// 						<del><p>昨日通告：共9场,甩戏1场,完成8场</p></del>
	...
	// 					<canvas id="star" style="width:100%;height:300px"></canvas>
	...
	//   			<h2 class="page-header">费用进度</h2>

	//   			<div class="col-md-6">

	//   				<div>

	// 						<canvas id="cost" style="width:100%;height:300px"/>

	// 					</div>

	//       		<p>已支出：	<strong>6,258,268.91</strong>(CNY)元</p>

	//       		<p>总预算：	<strong>55,373,550.00</strong>(CNY)元</p>

	//       	</div>

	//       	<div class="col-md-6">

	//       		<p>单集投资：1,287,756.98(CNY)万</p>

	// 					<p>已拍摄4天，单日拍摄摊分成本：1,564,567.23元</p>
	...
	var barData = {
		labels: ["弗拉基米尔", "莱昂纳多", "梁朝伟", "苏菲玛索"],
		datasets: [{
			fillColor: "rgba(220,220,220,0.5)",
			strokeColor: "rgba(220,220,220,1)",
			data: [912, 986, 1298, 842]
		}, {
	...
	module.exports = {
		ready: function ready() {
			...
			var cost = document.getElementById("cost").getContext("2d");
			new Chart(cost).Doughnut(doughnutData);

			var star = document.getElementById("star").getContext("2d");
			new Chart(star).Bar(barData);
		}
	};
